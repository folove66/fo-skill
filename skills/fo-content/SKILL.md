...
开始审稿前必须读取：
1. `~/.claude/知识库/爆款研究报告2026.3.20.md` — 46条数据规律，对照爆款/扑街规律审稿
2. `~/.claude/知识库/fo导语言体系.md` — 签名、专属词汇、句式模板
...
> 📚 深度参考：~/.claude/知识库/知识库_蒸馏总纲.md、~/.claude/知识库/fo导语言体系.md、~/.claude/知识库/爆款研究报告2026.3.20.md、~/.claude/知识库/AI写作提示词技巧.md
